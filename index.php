...
if ($login->isUserLoggedIn() == true) {
    // the user is logged in. shows the chatbox.
	?>
	<html>
	...
	<h1><font color="white">ChatBox</font></h1>
	<form onsubmit="signInOut();return false" id="signInForm">
		<input id="userName" type="text">
		<input id="signInButt" name="signIn" type="submit" value="Enter">
    ...
    // the user is not logged in. we redirect him to the not logged in page.
